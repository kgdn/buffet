            ...
            <Container>
                <Row>
                    <Col className='text-center'>
                        ...
                        <p className='mb-0' style={{ marginLeft: '10px' }}>&copy; {new Date().getFullYear()} Kieran Gordon &middot; This website is licensed under the <a href='https://www.gnu.org/licenses/agpl-3.0.en.html'>GNU Affero General Public License v3.0</a>.</p>
